...
Sub-step programming, variable step length, step probabilty, volume automisation as well as full or partial sequence and track randomisation is avaible for experimenting with.
